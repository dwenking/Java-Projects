...
public class HtmlCrawler implements Runnable{
	...
	private static String tempPath = "C:\\Users\\86187\\Desktop\\res";// 结果保存目录
	String url;
	...
	public void run() 
	{
		try 
		{
			...
			File file=new File(tempPath+"/"+url.substring(38,42));
			...
			String htmlPath = file+"/"+System.currentTimeMillis() + (new Random().nextInt(1000)) +".html";//图片路径
