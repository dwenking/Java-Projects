...
public class OrgJsonTest {
    ...
    public static JSONObject testJsonObject(ClassA t) {
    	...
    	*/
    	...
    	obj.put("a", t.getA());
    	//obj.put("b", JSONArray.fromObject(t.getB()));
    	obj.put("b", t.getB());
        obj.put("c", dateToString(t.getC()));
       
        System.out.println(obj);        
        
        System.out.println("a: " + obj.getInt("a"));
        System.out.println("b: " + obj.getJSONArray("b"));
        System.out.println("c: " + obj.getString("c"));
